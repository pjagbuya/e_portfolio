  ...
  return (
    <main  className="py-6 backdrop-contrast-75" style={{backgroundColor: 'rgba(213,81,162,0.8)' }}>
     ...
     <div className="flex justify-center gap-4 my-4">
      <a href="https://github.com/your-username" target="_blank" className="hover:scale-110 transition-transform duration-300">
          <Image src={"https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white"} alt="GitHub"
              width={200} height={100}/>
      </a>

      <a href="https://linkedin.com/in/your-id" target="_blank" className="hover:scale-110 transition-transform duration-300">
